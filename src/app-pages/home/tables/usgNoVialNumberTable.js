...
const UsgNoVialNumbersTable = connect(
  ...
  ({
    ...
    <div className='ag-theme-balham' style={{ height: '600px', width: '100%' }}>
      ...
      >
        <AgGridColumn field='mrID' headerName='mrId' width={100} cellRenderer='mrIdCellRenderer' cellRendererParams={{ uri: '/sites-list/datasheet/missouriRiver-edit', type: 'home'}} sortable unSortIcon />
