          ...
          <div className='container-fluid'>
            {!edit && (
              <>
                ...
                <p>
                  <b>Note:</b> Some dropdown options are dependent from other
                  fields.
                </p>
              </>
            )}
            ...
            <Row>
              <div className='col-md-6 col-xs-12'>
                <FilterSelect
                  ...
                  helperContent={
                    <>
                      Must select <b>Field Office</b> and <b>Project</b> to see
                      Segment options. <br></br>
                      Two ways to select option:
                      <ol>
                        <li>
                          Click on input box and select option from dropdown, or{' '}
                        </li>
            ...
            <Row>
              <div className='col-md-4 col-xs-12'>
                <SelectCustomLabel
                  ...
                  helperContent={
                    <>
                      Must select <b>Project</b> to see Sample Unit Type
                      options. <br></br>
                    </>
                  }
                  isRequired
              ...
              <div className='col-md-8 col-xs-12'>
                <FilterSelect
                  ...
                  helperContent={
                    <>
                      Must select <b>Segment</b> and <b>Sample Unit Type</b> to
                      see Sample Unit options. <br></br>
                      Two ways to select option:
                      <ol>
                        <li>
                          Click on input box and select option from dropdown, or{' '}
