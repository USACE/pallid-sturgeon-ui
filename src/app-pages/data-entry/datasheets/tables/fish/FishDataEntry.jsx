...
const FishDataEntry = connect('selectDataEntryFishData', 'selectBaseData', ({ dataEntryFishData, baseData }) => {
  ...
  const tableColumns = useMemo(
    () => [
      ...
      columnHelper.accessor('species', {
        ...
        meta: {
          type: 'select',
          options: [{}], // @TODO: Will be addressed in CWBI-28139 Lookup Tables
        },
      }),
