          ...
          <Card.Body>
            <Row>
              ...
              <div className='col-2'>
                <Input
                  name='radioTagNum'
                  label='Radio Tag Number'
                  type='number'
                  value={state['radioTagNum'] || ''}
              ...
              <div className='col-2'>
                <Input
                  name='captureDate'
                  label='Capture Time (hh:mm:ss)'
                  value={state['captureDate']}
