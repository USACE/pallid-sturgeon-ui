          ...
          <Card.Body>
            <Row>
              ...
              <div className='col-2'>
                <Input
                  name='procedureBy'
                  label='Procedure By Initials'
                  value={state['procedureBy']}
                  onChange={handleChange}
                  isRequired
                />
              </div>
              <div className='col-2'>
                <Input
                  name='oldRadioTagNum'
                  label='Old Radio Tag Number'
                  type='number'
                  value={state['oldRadioTagNum'] || ''}
            ...
            <Row>
              ...
              <div className='col-2'>
                <Input
                  name='dstSerialNum'
                  label='DST Serial Number'
                  type='number'
                  value={state['dstSerialNum'] || ''}
                  onChange={handleNumber}
                />
              </div>
              <div className='col-2'>
              ...
              <div className='col-2'>
                <Input
                  name='dstStartTime'
                  label='DST Start Time (hh:mm:ss)'
                  value={state['dstStartTime']}
                  onChange={handleChange}
                />
              </div>
              <div className='col-2 text-center'>
                <label>
                  <small>DST Reimplanted</small>
                </label>
                <input
                  name='dstReimplant'
                  type='checkbox'
              ...
              <div className='col-2'>
                <Input
                  name='newRadioTagNum'
                  label='New Radio Tag Number'
                  type='number'
                  value={state['newRadioTagNum']}
                  onChange={handleNumber}
                  isRequired
                />
              </div>
            ...
            <Row>
              ...
              <div className='col-2'>
                <Input
                  name='ultrasoundGonadLength'
                  label='Ultrasound Gonad Length'
                  type='number'
                  value={state['ultrasoundGonadLength'] || ''}
                  onChange={handleNumber}
                />
              </div>
              <div className='col-2'>
                <Input
                  name='gonadCondition'
                  label='Gonad Condition'
                  value={state['gonadCondition']}
              ...
              <div className='col-2 text-center'>
                <label>
                  <small>Antibiotic Injection</small>
                </label>
                <input
            ...
            <Row>
              <div className='col-2'>
                <Input
                  name='expectedSpawnYear'
                  label='Expected Spawn Year'
                  type='number'
                  value={state['expectedSpawnYear'] || ''}
                  onChange={handleNumber}
                />
              </div>
              <div className='col-4'>
              ...
              <div className='col-4'>
                <TextArea
                  name='fishHealthComment'
                  label='Fish Health Comments'
                  value={state['fishHealthComment']}
                  onChange={handleChange}
                />
              </div>
            </Row>
