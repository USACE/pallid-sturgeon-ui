        ...
        <Card className='mt-3'>
          ...
          <Card.Body>
            ...
            <span className='info-message ml-2'>
              Click the "Export as CSV" link at the top of the report to
              download the Genetic Card Summary for the year and filters
              selected. The displayed report below only shows a portion of the
              fields that are included in the downloaded report.
            </span>
            <div className='row mt-3'>
              <div className='col-md-2 col-xs-12'>
                <Select
                  ...
                  value={year}
                  onChange={(val) =>
                    doUpdateGeneticCardSummaryParams({ year: val })
                  }
            ...
            <div className='row mt-2'>
              <div className='col-md-2 col-xs-12'>
                <Select
                  ...
                  value={broodstock}
                  onChange={(val) =>
                    doUpdateGeneticCardSummaryParams({ broodstock: val })
                  }
              ...
              <div className='col-md-2 col-xs-12'>
                <Select
                  ...
                  value={hatchWild}
                  onChange={(val) =>
                    doUpdateGeneticCardSummaryParams({ hatchWild: val })
                  }
                  options={yesNoOptions}
                />
              </div>
              <div className='col-md-2 col-xs-12'>
                <Select
                  ...
                  value={speciesId}
                  onChange={(val) =>
                    doUpdateGeneticCardSummaryParams({ speciesId: val })
                  }
                  options={yesNoOptions}
                />
              </div>
        ...
        <Card className='mt-3'>
          ...
          <Card.Body>
            <Button
              ...
              handleClick={() =>
                doFetchAllGeneticCardSummary('genetic-card-summary')
              }
            />
            <div
            ...
            >
              ...
              >
                ...
                <AgGridColumn
                  field='geneticVialNum'
                  headerName='Genetic Vial #'
                  sortable
                  unSortIcon
                />
                <AgGridColumn
                ...
                <AgGridColumn
                  field='broodstock'
                  headerName='Broodstock?'
                  sortable
                  unSortIcon
                />
                <AgGridColumn
                  field='hatchwild'
                  headerName='Hatch/Wild?'
                  sortable
                  unSortIcon
                />
                <AgGridColumn
