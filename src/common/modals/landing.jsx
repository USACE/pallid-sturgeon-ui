...
const LandingModal = () => (
  <ModalContent size='lg'>
      ...
      <div className='container-fluid'>
        <p>
          <b>
            ...
            (which includes any device attached to this IS), you can consent to
        ...
        <ul>
          ...
          <li>
            ...
            are subject to routine monitoring, interceptions, and search, and
          ...
          <li>
            ...
            searching or monitoring of the content of privileged communications,
            or work product, to personal representation or services by
    ...
    <ModalFooter doModalClose saveText='I Accept' />
  </ModalContent>
);
