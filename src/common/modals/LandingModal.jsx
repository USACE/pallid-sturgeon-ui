      ...
      <section className='modal-body'>
        <div className='container-fluid'>
          <p className='text-bold'>
            ...
            only. By using this IS (which includes any device attached to this IS), you can consent to the following
            conditions:
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              interceptions, and search, and may be disclosed or used for any USG-authorized purpose.
            </li>
            <li>
            ...
            <li>
              this IS does not constitute consent to PM, LE or CI investigative searching or monitoring of the content
              of privileged communications, or work product, to personal representation or services by attorneys,
              psychotherapists, or clergy, and their assistants. Such communications and work product are private and
