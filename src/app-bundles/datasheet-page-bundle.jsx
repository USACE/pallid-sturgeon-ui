    ...
    ({ dispatch, store, apiGet }) => {
      ...
      apiGet(url, (err, body) => {
        if (!err && body.status) {
          ...
          dispatch({
            type: 'PROCEDURE_DATA_SUMMARY_FETCH_ERROR',
            payload: err,
          });
        }
      });
    ...
    ({ dispatch, store, apiGet }) => {
      ...
      apiGet(url, (err, body) => {
        if (!err && body.status) {
          ...
          dispatch({
            type: 'TELEMETRY_DATA_SUMMARY_FETCH_ERROR',
            payload: err,
          });
        }
      });
